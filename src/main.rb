...
require "open-uri"
require "yaml"
%w{alert notification quit_window tray preference_panel report welcome_window change_options_panel progress_window directory_tree sass_convert_panel}.each do | f |
  require "ui/#{f}"
end
